...
namespace Maikelsoft.Monads
{
    ...
    {
        [Pure]
        public static Try2<T> FromException<T>(Exception exception) where T : notnull
        {
        ...
        [Pure]
        public static Try2<T> FromError<T>(string errorMessage, string? details = null) where T : notnull
        {
        ...
        [Pure]
        public static Try2<T> Create<T>(Func<T> func) where T : notnull
        {
        ...
        [Pure]
        public static async Task<Try2<T>> Create<T>(Func<Task<T>> func) where T : notnull
        {
        ...
        [Pure]
        public static Try2<T> FromError<T>(Error error) where T : notnull
        {
        ...
        [Pure]
        public static Try2<T> FromValue<T>(T value) where T : notnull
        {
